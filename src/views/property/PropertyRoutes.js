...
export default function Property() {
  const Showunit = React.lazy(() => import('./unit/ShowUnitModule/ShowUnit'))
  const ShowContract = React.lazy(() =>
    import('./propertynav/Contracts/ShowContracts/ShowContract'),
  )
  ...
  const ShowInvoices = React.lazy(() => import('../finance/ShowInvoices'))
  ...
  const EditBuilding = React.lazy(() => import('./propertynav/Building/EditBuilding'))
