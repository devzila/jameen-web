            ...
            <div className="card-body p-5">
              ...
              <table className="table border-bottom border-gray-200 mt-3">
                ...
                <tbody className="font-monospace fw-light">
                  <tr>
                    ...
                    <td className="text-end px-0 font-monospace">$60.00</td>
                  </tr>
                  <tr>
                    <td className="px-0">Website design</td>
                    <td className="text-end px-0 font-monospace">$80.00</td>
                  </tr>
                </tbody>
              </table>
              ...
              <div className="mt-5">
                ...
                <div className="d-flex justify-content-end mt-3">
                  ...
                  <h5 className="text-success font-monospace">$399.99 USD</h5>
                </div>
              </div>
            </div>
            <a
