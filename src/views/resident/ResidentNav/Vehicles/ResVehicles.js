        ...
        <div>
          <Card className="border-0 mt-3 p-2 rounded-2">
            <div className="d-flex  ms-2 justify-content-between">
              <div className="fs-4 border-0">Vehicles</div>
                    ...
                    <table className="table mb-0">
                      ...
                      >
                        <tr>
                          ...
                          <th className="pt-3 pb-3 border-0">Registration No.</th>
                          <th className="pt-3 pb-3 border-0">Year Built </th>
                          <th className="pt-3 pb-3 border-0">Tag</th>
                        </tr>
                      </thead>
                          ...
                          <tr key={resvehicles.id}>
                            ...
                            <td>
                              <Dropdown key={resvehicles.id}>
                                ...
                                <Dropdown.Menu>
                                  <EditVehices id={resvehicles.id} after_submit={reload_callback} />
                                </Dropdown.Menu>
                              </Dropdown>
                            </td>
                          </tr>
