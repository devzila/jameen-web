            ...
            <CCard className=" rounded-0 border-0 shadow-sm">
              ...
              <CCardBody className="p-5">
                <div className="d-flex align-items-end">
                  <CIcon icon={freeSet.cilEnvelopeClosed} size="3xl" />
                  <h3 className="m-0 px-3">Email</h3>
                </div>
                <div className="text-secondary text-monospace mt-4">
                  <p className="p-0 m-0">
                    Check yout inbox for an email from Jameen. Click on the password
                  </p>
                  <p className="p-0 m-0">reset link inside the email to complete the process.</p>
                  <p className="mb-3">Don&apos;t see the email? Check the spam folder.</p>
                </div>
              </CCardBody>
